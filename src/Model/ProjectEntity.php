...
class ProjectEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        if (($budget > 9E+11)) {
            throw new \InvalidArgumentException('invalid value for $budget when calling ProjectEntity., must be smaller than or equal to 9E+11.');
        }
        if (($budget < 0)) {
    ...
    public function setTimeBudget($timeBudget)
    {
        if (($timeBudget > 2145600000)) {
            throw new \InvalidArgumentException('invalid value for $timeBudget when calling ProjectEntity., must be smaller than or equal to 2145600000.');
        }
        if (($timeBudget < 0)) {
            throw new \InvalidArgumentException('invalid value for $timeBudget when calling ProjectEntity., must be bigger than or equal to 0.');
        }
