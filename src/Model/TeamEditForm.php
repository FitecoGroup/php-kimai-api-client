 ...
 */
class TeamEditForm implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TeamEditForm';
     ...
     * Sets teamlead.
     *
     * @param int $teamlead User ID for the teamlead
     *
     * @return self
     */
     ...
     * Sets users.
     *
     * @param int[] $users Array of team member IDs
     *
     * @return self
     */
