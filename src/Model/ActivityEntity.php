 ...
 */
class ActivityEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ActivityEntity';
    ...
    protected static $openAPITypes = [
        ...
        'budget'      => 'float',
        'timeBudget'  => 'int',
        'metaFields'  => '\Fiteco\KimaiClient\Model\ActivityMeta[]',
    ...
    {
        if (($budget > 9E+11)) {
            throw new \InvalidArgumentException('invalid value for $budget when calling ActivityEntity., must be smaller than or equal to 9E+11.');
        }
        if (($budget < 0)) {
            throw new \InvalidArgumentException('invalid value for $budget when calling ActivityEntity., must be bigger than or equal to 0.');
        }
    ...
    public function setTimeBudget($timeBudget)
    {
        if (($timeBudget > 2145600000)) {
            throw new \InvalidArgumentException('invalid value for $timeBudget when calling ActivityEntity., must be smaller than or equal to 2145600000.');
        }
        if (($timeBudget < 0)) {
            throw new \InvalidArgumentException('invalid value for $timeBudget when calling ActivityEntity., must be bigger than or equal to 0.');
        }
     ...
     * Gets metaFields.
     *
     * @return \Fiteco\KimaiClient\Model\ActivityMeta[]|null
     */
     ...
     * Sets metaFields.
     *
     * @param \Fiteco\KimaiClient\Model\ActivityMeta[]|null $metaFields All visible meta (custom) fields registered with this activity
     *
     * @return self
     */
     ...
     * Sets teams.
     *
     * @param \Fiteco\KimaiClient\Model\Team[]|null $teams If no team is assigned, everyone can access the activity
     *
     * @return self
     */
