 ...
 */
class ActivityEditForm implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ActivityEditForm';
     ...
     * Sets project.
     *
     * @param int|null $project Project ID
     *
     * @return self
     */
