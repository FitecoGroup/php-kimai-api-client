...
/**
 * CustomerRate Class Doc Comment.
 *
 * @category Class
 *
 ...
 */
class CustomerRate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CustomerRate';
    ...
    protected static $openAPITypes = [
        'id'           => 'int',
        'user'         => '\Fiteco\KimaiClient\Model\User',
        'rate'         => 'float',
        'internalRate' => 'float',
        'isFixed'      => 'bool',
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (null === $this->container['isFixed']) {
            $invalidProperties[] = "'isFixed' can't be null";
        }
     ...
     * Sets user.
     *
     * @param \Fiteco\KimaiClient\Model\User|null $user user
     *
     * @return self
     */
