 ...
 */
class ProjectExpanded implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ProjectExpanded';
    ...
    protected static $openAPITypes = [
        'id'       => 'int',
        'customer' => '\Fiteco\KimaiClient\Model\Customer',
        'name'     => 'string',
        'visible'  => 'bool',
        'color'    => 'string',
    ];
     ...
     * Gets customer.
     *
     * @return \Fiteco\KimaiClient\Model\Customer
     */
     ...
     * Sets customer.
     *
     * @param \Fiteco\KimaiClient\Model\Customer $customer customer
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 150)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ProjectExpanded., must be smaller than or equal to 150.');
        }
        if ((mb_strlen($name) < 2)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ProjectExpanded., must be bigger than or equal to 2.');
        }
