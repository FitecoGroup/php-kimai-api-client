 ...
 */
class UserEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UserEntity';
    ...
    public function listInvalidProperties()
    {
        ...
        if (null !== $this->container['title'] && (mb_strlen($this->container['title']) > 50)) {
            $invalidProperties[] = "invalid value for 'title', the character length must be smaller than or equal to 50.";
        }

        if (null !== $this->container['avatar'] && (mb_strlen($this->container['avatar']) > 255)) {
    ...
    public function setAlias($alias)
    {
        if (null !== $alias && (mb_strlen($alias) > 60)) {
            throw new \InvalidArgumentException('invalid length for $alias when calling UserEntity., must be smaller than or equal to 60.');
        }
    ...
    {
        if (null !== $title && (mb_strlen($title) > 50)) {
            throw new \InvalidArgumentException('invalid length for $title when calling UserEntity., must be smaller than or equal to 50.');
        }
    ...
    {
        if (null !== $avatar && (mb_strlen($avatar) > 255)) {
            throw new \InvalidArgumentException('invalid length for $avatar when calling UserEntity., must be smaller than or equal to 255.');
        }
     ...
     * Sets teams.
     *
     * @param \Fiteco\KimaiClient\Model\Team[]|null $teams teams
     *
     * @return self
     */
